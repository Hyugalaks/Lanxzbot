...
await Maria.sendMessage(from, {text: Ayushlod[i], edit: key });
        ...
        if (autobio) {
            Maria.updateProfileStatus(`Hey, future leaders! 🌟 Lanxzbot is here to inspire and lead, thanks to Alia floiyrine, Inc. 🚀 ${runtime(process.uptime())} `).catch(_ => _)
        }
...
I am *Lanxzbot*, a whatsapp bot created by Lanxz
